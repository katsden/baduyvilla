...
function santapan() {
  var isi = [
    ...
    '    <img src="assets/img/santapan-beranda.jpg" alt="Meja kayu jati rendah dengan mangkuk tanah berisi nasi dan sayur di atas tikar anyaman." fetchpriority="high" width="900" height="1200">',
...
function pengalaman() {
  var isi = [
    ...
    '  <section class="media r-hero" data-scrim="bawah" data-parallax',
    '           style="display:grid; place-items:end start; text-align:left">',
    '    <img src="assets/img/pengalaman-beranda.jpg" alt="Pisau bambu, pintalan berbenang nila, dan tenunan setengah jadi di atas kain nila." fetchpriority="high" width="900" height="1200">',
    '    <div class="wadah" style="position:relative; z-index:3; padding-bottom:var(--sp-5)">',
...
function reservasi() {
  ...
  var isi = [
    ...
    '      <div class="grid">',
    '        <div class="kolom-kiri" data-reveal-grup>',
    '          <span class="label" data-reveal>Reservasi</span>',
    '          <h1 data-reveal style="margin-top:var(--sp-2)">Tanya dulu,<br>tidak apa-apa</h1>',
    '        </div>',
    '      </div>',
    '',
...
function terimaKasih() {
  var isi = [
    ...
    '            <a class="tautan" data-buka-lagi href="https://wa.me/6281234567890">Buka WhatsApp lagi</a>',
    '          </p>',
